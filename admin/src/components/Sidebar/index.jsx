...
import { AiOutlineDashboard,AiOutlineDown, AiOutlineAppstore, AiOutlineDollar, AiOutlineTeam, AiOutlineUser, AiOutlineBarChart } from 'react-icons/ai';
        ...
        <nav className="mt-5 py-4 px-4 lg:mt-9 lg:px-6">
          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <SidebarLinkGroup
                activeCondition={
                  pathname === '/catalog' || pathname.includes('catalog')
                }
              >
                {(handleClick, open) => {
                  return (
              ...
              <SidebarLinkGroup
                activeCondition={
                  pathname === '/usermanagement' || pathname.includes('usermanagement')
                }
              >
                {(handleClick, open) => {
                  return (
