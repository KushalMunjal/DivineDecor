...
const SignIn = () => {
  const [username, setUsername] = useState(''); // Changed email state to username
  const [password, setPassword] = useState('');

  const handleUsernameChange = (e) => { // Changed email to username
          ...
          <div className="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
              ...
              <form onSubmit={handleSubmit}>
                <div className="mb-4">
                  ...
                  <div className="relative">
                    <input
                       ...
                       onChange={handleUsernameChange} // Changed onChange event handler
                ...
                className="w-full mt-4 py-4 bg-primary text-white font-semibold rounded-lg transition duration-200 hover:bg-primary-dark focus:outline-none focus:ring-2 focus:ring-primary"
              >
                Sign In
              </button>
                </div>
